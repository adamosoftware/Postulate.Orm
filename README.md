...
- Most methods have at least two overloads -- one that accepts `IDbConnection` already open, and one that opens and closes a connection within the scope of the method.
